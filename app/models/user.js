...
const Validations = buildValidations({
  ...
  jobTitle: validator('belongs-to'),
  locations: validator('has-many')
...
export default Model.extend(Validations, {
  name: attr('string'),
  email: attr('string'),
  hashedEmail: attr('string'),
  password: attr('string'),
  passwordConfirmation: attr('string'),
  bio: attr(),
  confirmed: attr({ readOnly: true }),
  verified: attr({ readOnly: true }),
  terms: attr(),
  gmc: attr(),
  idToken: attr(),
  ...
  logbooks: hasMany('logbooks'),
  logbookEntries: hasMany('logbook-entry'),
  notificationPreferenceId: attr(),
  notificationPreference: belongsTo('notification-preference'),
